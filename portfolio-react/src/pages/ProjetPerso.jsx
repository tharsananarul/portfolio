    ...
    <main className="relative bg-primary">
        ...
        <div className="absolute inset-0 flex flex-col justify-end section-container pb-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-8xl font-extrabold text-white tracking-tighter">
              Projets <span className="highlight">Perso.</span>
            </h1>
          </motion.div>
        </div>
      </div>
      ...
      <section className="section-container grid grid-cols-2 md:grid-cols-4 gap-8 py-16 border-b border-white/5">
        <div className="space-y-2">
          ...
          <p className="font-bold">Créations Libres</p>
        </div>
        <div className="space-y-2">
          <span className="text-xs font-bold uppercase tracking-widest text-text-muted">Focus</span>
          <p className="font-bold">Illustrations & Posters</p>
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          <span className="text-xs font-bold uppercase tracking-widest text-text-muted">Thème</span>
          <p className="font-bold">Cinéma & Culture</p>
        </div>
      </section>
